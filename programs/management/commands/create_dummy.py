...
class Command(BaseCommand):
        ...
        def handle(self, *args, **options):
                ...
                title = ['꽃꽂이 체험반', '비누만들기 체험반', '필라테스 체험반', '필라테스 성인반', '수영 성인반', '바이올린 체험반', '플룻 체험반', '첼로 체험반', 
                        '피아노 체험반', '줄넘기 청소년반', '태권도 청소년반', '바리스타 자격증', '바리스타 자격증', '바리스타 자격증', '수영 초급반', '댄스 자격증',
                ...
                categories = [['취미', '체험'], ['취미', '체험'], ['취미', '운동'], ['취미', '운동'], ['취미', '운동'], ['체험', '음악'], ['체험', '음악'], ['체험', '음악'],
                                ['체험', '음악'], ['체험', '운동'], ['체험', '운동'], ['자격증', '중급'], ['자격증', '초급'], ['자격증', '초급'], ['취미', '운동'], ['자격증', '초급'],
